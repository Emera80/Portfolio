...
export default function ContactSection() {
    ...
    const word = "TCATNOC";
    return (
        <section id="contact" className="min-h-screen scroll-mt-10 bg-[#0A0A0A] flex items-center justify-center gap-40 pt-30 w-full overflow-visible">
            ...
            <div className=" bloc2 flex flex-col gap-10  w-[90%] z-10">
                <div className="box1 flex flex-col w-full ">
                    <div className=" box1-2 translate-y-[-40%] ">
                        <div className="flex  gap-5">
                            ...
                            <div>
                                <h2 className="text-[13px] translate-y-[-15%] tracking-[0.1rem] font-bold text-white border-2 border-solid border-[#c15525] inline-block px-3 py-1 uppercase">Get in touch</h2>
                                <p className="text-white font-black text-7xl">LET'S BUILD<span className="text-[#c15525]"> SOMETHING</span> <br/>TOGETHER</p>
                            </div>
                        </div>
                    </div>
                </div>
              ...
              ========================================= */}
                        <div className="w-full lg:w-1/3 flex flex-col gap-6">
                            ...
                            <div className="bg-[#111111] border border-white/10 rounded-2xl p-8 hover:border-white/20 transition-colors">
                ...
                <span className="relative flex h-3 w-3">
                  ...
                  Available for work
                                ...
                                <p className="text-neutral-400 text-sm leading-relaxed">
                                    Based in Tunis, Tunisia. I respond to most messages within 24 hours. For urgent matters, email me directly.
                                </p>
                            </div>
              ...
              <span className="text-xs font-bold tracking-widest text-neutral-500 uppercase mb-4 block">
                Direct
                                ...
                                <a href="mailto:emeraudetshiyoyo@gmail.com" className="text-white text-lg font-medium hover:text-[#c15525] transition-colors flex items-center gap-3 mb-8">
                                    <FiMail className="text-[#c15525]" size={20} />
                                    emeraudetshiyoyo@gmail.com
                                </a>

                                <div className="flex gap-4">
                                    <a href="https://github.com/Emera80" target="_blank" rel="noreferrer" className="p-3 bg-white/5 border border-white/10 rounded-full text-neutral-400 hover:text-white hover:border-[#c15525] hover:bg-[#c15525]/10 transition-all">
                                        <FiGithub size={20} />
                                    </a>
                                    <a href="https://www.linkedin.com/in/%C3%A9meraude-tshiyoyo-7087b0406/" target="_blank" rel="noreferrer" className="p-3 bg-white/5 border border-white/10 rounded-full text-neutral-400 hover:text-white hover:border-[#c15525] hover:bg-[#c15525]/10 transition-all">
                                        <FiLinkedin size={20} />
                                    </a>
                                </div>
                            </div>
                            ...
                            <form ref={form} onSubmit={sendEmail} className="flex flex-col gap-6">
                                ...
                                <div className="flex flex-col md:flex-row gap-6">
                                    <div className="flex-1 flex flex-col gap-2">
                                        <label htmlFor="name" className="text-xs font-bold tracking-widest text-neutral-500 uppercase">
                                            Name
                                        </label>
                                        <input
                                            type="text"
                                    ...
                                    <div className="flex-1 flex flex-col gap-2">
                                        <label htmlFor="email" className="text-xs font-bold tracking-widest text-neutral-500 uppercase">
                                            Email
                                        </label>
                                        <input
                                            type="email"
                                ...
                                <div className="flex flex-col gap-2">
                                    <label htmlFor="subject" className="text-xs font-bold tracking-widest text-neutral-500 uppercase">
                                        Subject
                                    </label>
                                    <input
                                        type="text"
                                ...
                                {/* Ligne 3 : Message */}
                                <div className="flex flex-col gap-2">
                                    <label htmlFor="message" className="text-xs font-bold tracking-widest text-neutral-500 uppercase">
                                        Project / Idea
                                    </label>
                                    <textarea
                                        id="message"
                                ...
                                {/* Message d'état */}
                                {statusMessage.text && (
                                    <div className={`p-4 rounded-lg text-sm font-medium ${statusMessage.type === 'success' ? 'bg-green-500/10 text-green-400 border border-green-500/20' : 'bg-red-500/10 text-red-400 border border-red-500/20'}`}>
                                        {statusMessage.text}
                                    </div>
                                )}
